...
Two judges show non-significant style effects at $n = 330$: GPT-4o (Style OR $= 1.06$, $p = .665$) and Claude (Style OR $= 1.22$, $p = .134$), with their elevated BT reflecting originality rather than style preference (Orig OR $1.96$ and $1.69$ respectively).
As predicted by the power analysis (Figure~\ref{fig:power_curve}), Likert begins detecting the strongest effects at $n \approx 330$ (Qwen3 $d = .15$, $p < .001$; Llama $d = .16$, $p < .001$), while three judges maintain the Blindspot (GPT-4o $d = {-}.03$, NS; Claude $d = .03$, NS; Gemini borderline $d = .09$, $p = .02$ by Wilcoxon but $p = .11$ by $t$-test).
